...
/**
 * Diálogo para el registro de un nuevo productor.
 */
public class RegistroProductorDialog extends JDialog {
    ...
    private final ProductorController controller = new ProductorController();

    public RegistroProductorDialog(Frame owner) {
        super(owner, "Registrar productor", true);
        setSize(520, 480);
    ...
    private void initUI() {
        ...
        JPanel header = UIStyle.sectionHeader(
                ...
                "Ingresa los datos de acceso y personales del productor."
        );
        ...
        // Título bloque datos personales
        row++;
        gbc.gridx = 0; gbc.gridy = row;
        gbc.gridwidth = 2;
        form.add(UIStyle.formLabel("Datos del productor"), gbc);
        ...
        // Relleno vertical para empujar todo hacia arriba
        row++;
        gbc.gridx = 0; gbc.gridy = row;
        gbc.gridwidth = 2;
        gbc.weighty = 1;
        ...
        // Lo metemos en un scroll para que nunca se corte
        ...
        JButton btnGuardar = UIStyle.primaryButton("Registrar productor");
    ...
    private void guardar() {
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    ex.getMessage(),
                    "Error en registro de productor",
